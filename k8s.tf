##################################################################################################
## Query the client configuration for our current service account, which should have permission ##
## to talk to the GKE cluster since it created it.                                              ##
##################################################################################################
...
#################################################################################################
##  Create a kubernetes secret containing the vault certificates and keys                      ##
#################################################################################################
...
#################################################################################################
##  Create a kubernetes stateful set for vault. StatefulSets ensure that each pod is deployed  ##
##  in order. This is important for the initial bootstrapping process,otherwise there's a race ##
##  for which Vault server initializes first with auto-init                                    ##
#################################################################################################
...
#################################################################################################
## Log the vault server token to the terminal                                                  ##
#################################################################################################
